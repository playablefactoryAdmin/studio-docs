...
- [Common Fields](datajs/commonfields.md)
- [GlobalProps](datajs/globalprops.md)
...
- [Basic Types](datajs/basic-types)
  ...
  - [ColorAdvanced](datajs/basic-types/coloradvanceddata.md)
  - [Text](datajs/basic-types/textdata.md)
  - [RichText](datajs/basic-types/richtextdata.md)
...
- [Selection/Order Types](datajs/selectorder-types)
  ...
  - [SlotText](datajs/selectorder-types/slottextdata.md)
...
- [AI Types](datajs/ai-types)

  - [Voiceover](datajs/ai-types/voiceoverdata.md)
  - [AudioWithAI](datajs/ai-types/audiowithaidata.md)
  - [AIAvatar](datajs/ai-types/aiavatardata.md)

- [End Card / Shell Types](datajs/endcard-types)

  - [Preloader](datajs/endcard-types/preloaderdata.md)
  - [Version](datajs/endcard-types/versiondata.md)
  - [CustomFields](datajs/endcard-types/customfieldsdata.md)
  - [IEC](datajs/endcard-types/iecdata.md)
  - [IEC2](datajs/endcard-types/iec2data.md)
