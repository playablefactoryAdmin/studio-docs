...
With this feature enabled, users on the platform can interact with the responsive 2D component and view the results in real time.
...
With this feature enabled, users on the platform can interact with x, y and scale properties of the object and view the results in real time.
