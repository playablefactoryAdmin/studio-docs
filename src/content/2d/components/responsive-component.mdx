...
# Responsive 2D Component

<Image src="/studio-docs/components/responsive-component.png" alt="Responsive Component" width={400} height={300} className="mt-6 rounded-xl" />
...
<UserTable data={
    [
        { name: "px", desc: "To offset in pixels." },
        { name: "%", desc: "To offset by a percentage of the parent object." },
        { name: "self", desc: "To offset by a percentage of the object’s own size." },
    ]
} />
