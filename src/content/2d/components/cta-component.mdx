...
<SpecialHeader  
 ...
 usesComponentLink="/studio-docs/2d/objects/cta"
...
If enabled, the CTA's **visibility** can be toggled from the platform via `Data.js`.

#### Data.js ID and Name

* **ID** is internal and used for programmatic reference.
* **Name** is shown on the platform and acts as the label.
